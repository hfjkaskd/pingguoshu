...
[Preserve]
[GraphElementInfo(Category = "基础", Text = "加", SupportTypes = new Type[] {typeof(ActionGraphBase)})]
[Obfuz.ObfuzIgnore]
public class Variable_Vector3_Add : Variable_Vector3
{
    public override string DebugName => "加";
    public Vector3Wrapper v1;
    public Vector3Wrapper v2;

    public override object Clone()
    {
        var clone = new Variable_Vector3_Add();
