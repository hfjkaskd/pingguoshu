...
[Preserve]
[GraphElementInfo(Category = "基础", Text = "较大值", SupportTypes = new Type[] {typeof(ActionGraphBase)})]
[Obfuz.ObfuzIgnore]
public class Variable_Float_Max : Variable_Float
{
    ...
    {
        var clone = new Variable_Float_Max();
