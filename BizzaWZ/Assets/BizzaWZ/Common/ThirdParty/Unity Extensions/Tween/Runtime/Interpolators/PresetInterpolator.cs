...
namespace UnityExtensions.Tween
{
    ...
    public partial struct Interpolator
    {
        ...
        public static float Jitter(float t, float strength = 0.5f)
        {
            var random = RandomUtils.Create((uint)(t * int.MaxValue));
            random.NextUInt();
            random.NextUInt();

            float r;
            if (random.Test(strength))
            {
                do
                {
                    r = random.Gaussian(0.5f, 1f / 6f);
                }
                while (r < 0f || r > 1f);
            }
            else r = random.NextFloat();
        ...
        /// <returns> 插值结果 </returns>
        public static float Linear(float t, float strength = 0.5f)
        {
            return strength <= 0.5f ? (strength + strength) * t : t + (strength + strength - 1f) * (1f - t);
        }
        ...
        /// <param name="strength"> [0, 1] 范围的强度 </param>
        /// <returns> 插值结果 </returns>
        public static float Accelerate(float t, float strength = 0.5f)
        {
        ...
        /// <param name="strength"> [0, 1] 范围的强度 </param>
        /// <returns> 插值结果 </returns>
        public static float Decelerate(float t, float strength = 0.5f)
        {
            t = 1f - t;
        ...
        /// <param name="strength"> [0, 1] 范围的强度 </param>
        /// <returns> 插值结果 </returns>
        public static float AccelerateDecelerate(float t, float strength = 0.5f)
        {
            float tt = t * t;
        ...
        /// <param name="strength"> [0, 1] 范围的强度 </param>
        /// <returns> 插值结果 </returns>
        public static float Parabolic(float t, float strength = 0.5f)
        {
            float tmp = 4f * t * (1f - t);
            return (1f - strength - strength) * tmp * tmp + (strength + strength) * tmp;
        }
        ...
        {
            return Mathf.Sin(t * MathUtils.TwoPi);
        }
        ...
        /// <param name="strength"> [0, 1] 范围的强度 </param>
        /// <returns> 插值结果 </returns>
        public static float Sine(float t, float strength = 0.5f)
        {
            return Mathf.Sin((0.5f - strength + t) * MathUtils.TwoPi);
        }
        ...
        {
            return Mathf.Cos(t * MathUtils.TwoPi);
        }
        ...
        /// <param name="strength"> [0, 1] 范围的强度 </param>
        /// <returns> 插值结果 </returns>
        public static float Cosine(float t, float strength = 0.5f)
        {
            return Mathf.Cos((0.5f - strength + t) * MathUtils.TwoPi);
        }
