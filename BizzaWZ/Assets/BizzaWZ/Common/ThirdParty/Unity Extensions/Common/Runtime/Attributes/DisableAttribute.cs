...
namespace UnityExtensions
{
    ...
    public sealed class DisableAttribute : PropertyAttribute
    {
        ...
        /// <summary>
        /// Use a value to enabled or disable field editing, supports array
        /// </summary>
        ...
        class DisableDrawer : BasePropertyDrawer<DisableAttribute>
        {
            ...
            public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
            {
                ...
                if (attribute._mode > 0)
                {
                    ...
                    {
                        var parent = property.GetParentValue(target);
                        if (parent is IList) parent = property.GetParentValue(target, 2);
