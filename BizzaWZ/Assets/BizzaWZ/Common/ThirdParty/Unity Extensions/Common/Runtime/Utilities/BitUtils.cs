...
{
    /// <summary>
    /// Extensions for binary operations.
    /// </summary>
    public static class BitUtils
    {
        ...
        /// </summary>
        public static bool ContainsBits(this int value, int target) { return (value & target) == target; }


        /// <summary>
        /// Returns a Boolean value indicating whether any non-zero bit from a specified target occurs within this value.
        /// </summary>
        public static bool OverlapBits(this int value1, int value2) { return (value1 & value2) != 0; }
