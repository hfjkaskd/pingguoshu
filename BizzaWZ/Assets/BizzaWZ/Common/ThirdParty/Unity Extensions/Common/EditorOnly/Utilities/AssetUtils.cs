...
namespace UnityExtensions.Editor
{
    ...
    public static class AssetUtils
    {
        ...
        public static T FindAsset<T>() where T : Object
        {
            ...
            {
                var result = AssetDatabase.LoadAssetAtPath<T>(AssetDatabase.GUIDToAssetPath(guid));
        ...
        /// <summary>
        /// Find all isolated assets of specific type. A file contains one isolated asset.
        /// </summary>
        ...
        public static List<T> FindAssets<T>() where T : Object
        {
            ...
            foreach (var guid in guids)
            {
                ...
                {
                    if (asset is T result) results.Add(result);
                }
            }
