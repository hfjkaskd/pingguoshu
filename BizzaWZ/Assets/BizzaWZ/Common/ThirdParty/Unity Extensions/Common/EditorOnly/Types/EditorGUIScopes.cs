...
namespace UnityExtensions.Editor
{
    ...
    {
        public static DisabledScope New(bool disabled = true)
        {
                ...
                if (!_end)
                {
                    ...
                    if (_changed)
                    {
                        if (_undoRecordObject)
                        {
                            ...
                            EditorUtility.SetDirty(_undoRecordObject);
                        }
                        if (_undoRecordObjects != null)
                        {
                            Undo.RecordObjects(_undoRecordObjects, "[Multiple Objects]");
                            foreach (var o in _undoRecordObjects)
