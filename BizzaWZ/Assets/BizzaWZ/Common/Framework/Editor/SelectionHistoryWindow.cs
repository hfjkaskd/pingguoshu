...
public class SelectionHistoryWindow : EditorWindow
{
    ...
    public static void DrawObjectReference(UnityEngine.Object o, string name, GUIStyle style)
    {
        // Read mouse events
        ...
        guiElement.text = o != null ? name : "<invalid>";
        ...
        GUILayout.Label(guiElement, style, GUILayout.Height(EditorGUIUtility.singleLineHeight));
    ...
    void DrawHistory(bool favorites)
    {
        for (var i = 0; i < m_History.Count; i++)
        {
            ...
            DrawObjectReference(o,o.name, historyItemStyle);
